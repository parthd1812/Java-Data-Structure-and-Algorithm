...
public class MainDriver {
	...
	public static void main(String[] args) throws IOException {
		...
		String inputFile = "/Users/zhangmi/desktop/test.txt";
		...
		System.out.println( );
//		System.out.println("search the "+ tree1.search(toSearch));
...
//		ArrayList<Word> myarraylist = new ArrayList<Word>();
//		Word word = new Word("the",1,1);
////		word.addIndex(2);
////		word.addIndex(3);
//		Word word2 = new Word("the",1,1);
//		word2.addIndex(5);
//		word2.addIndex(6);
//		myarraylist.add(word);
//		myarraylist.add(word2);
//		
//		Word word3 = new Word("The",2,1);
////		word3.addIndex(1);
////		word3.addIndex(10);
//		myarraylist.add(word3);
//		
//		BST<Word> tree3 = index.buildIndex(myarraylist,new AlphaFreq());
		System.out.println("****RE-BUILD tree; alphabetically first and frequencies****\n" );
		BST<Word> tree3 = index.buildIndex(index.sortByFrequency(tree1), new IgnoreCase());
		System.out.println();
		System.out.println("the height is " + tree3.getHeight());
