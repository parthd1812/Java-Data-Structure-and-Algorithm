...
public class Test3 {
	...
	public static void main(String[] args) {
		Similarity file1 = new Similarity(new File("/Users/zhangmi/desktop/childrensbible.txt"));
		...
		Similarity file2 = new Similarity(new File("/Users/zhangmi/desktop/kjv.txt"));
